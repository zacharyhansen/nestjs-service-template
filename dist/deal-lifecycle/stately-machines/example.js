...
export const machine = setup({
    ...
    id: 'lifecycle',
    initial: 'submission',
    description: 'Represents the lifecycle of a deal of an opportunity. It is important to remember that an opportunities status is just the status of the active deal within the opportunity - in this way this is effectively a lifecycle for the opportunity as well. The active deal can be swapped out to different one to "move" an opportunity forward or backward in state.',
    states: {
        submission: {
            on: {
                'user.submit': {
                ...
                onDone: {
                    ...
                    actions: {
                        ...
                        params: {
                            ...
                            user_id: 238_923_892,
                            description: '[deal_id] has scompleted pricing. Please review and send out the contract.'
                        }
                    }
                },
                onError: {
